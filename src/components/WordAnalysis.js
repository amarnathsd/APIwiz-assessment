  ...
  return (
    <div>
      <div className="flex justify-evenly items-center mt-10">
        ...
        <div>
          <button className="w-40 me-20" onClick={onSubmit}>
            Process Word
          </button>
        </div>
      </div>
      ...
      <table className="w-full border">
        <thead className="">
          <tr className="flex justify-between">
            <th className="ms-5 th-left">Character</th>
            <th className="me-5 th-left">Word</th>
          </tr>
        </thead>
        <tbody>
          <tr className="flex justify-between">
    ...
    <div className="mt-10 border pt-5 ps-3 pb-5 me-20">
      <p className="">Definition: {definition || "No definition available"}</p>
